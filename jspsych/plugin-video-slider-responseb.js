var jsPsychVideoSliderResponseb = (function (jspsych) {
    'use strict';
  
    const info = {
        name: "video-slider-responseb",
        parameters: {
     ...
     */
    class VideoSliderResponsebPlugin {
        constructor(jsPsych) {
        ...
        `);
            ...
            display_element
                ...
                //response.rt = 
                response.rt.push(Math.round(endTime - startTime));
                //response.response = 
    ...
    VideoSliderResponsebPlugin.info = info;
  
    return VideoSliderResponsebPlugin;
